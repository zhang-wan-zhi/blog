<template>
  <div class="page">
    <div v-if="comments.length > 0" class="part part_output" style="text-align: start!important;">
    ...
    <div v-if="!type" @click="signIn" class="signIn">登录留言吧~~</div>
...
<script>
import { Guid, getDate } from "../../status/js/public.js";
import imgDefault from "../../status/image/avatar.png";
