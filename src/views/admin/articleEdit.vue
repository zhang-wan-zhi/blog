<template>
  <div class="edit_wrap">
    ...
    <div class="edit_head">首页图</div>
    <el-input v-model="pic" placeholder="请输入链接"></el-input>
    <div class="edit_head">主标签</div>
    <el-input v-model="classify" placeholder="主标签"></el-input>
    <div class="category">
  ...
  methods: {
    ...
    imgAdd(pos, $file) {
      this.$http({
        ...
        console.log(e);
        this.$refs.md.$img2Url(pos, e.data.avatar);
      });
      console.log("1122121", pos, $file);
    },
    // 删除图片
    imgDel(pos) {
      console.log(pos);
